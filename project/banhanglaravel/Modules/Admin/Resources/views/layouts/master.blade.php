...
<head>
    ...
    <!-- //bootstrap-css -->
    <!-- Custom CSS -->
    <link href="{{asset ('public/theme_admin/css/style.cs') }}s" rel='stylesheet' type='text/css' />
    ...
    <link href="{{asset ('public/theme_admin/css/font-awesome.cs') }}s" rel="stylesheet"> 
    <link rel="stylesheet" href="{{asset ('public/theme_admin/css/morris.css') }}" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="{{asset ('public/theme_admin/css/monthly.css') }}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="{{asset ('public/theme_admin/js/jquery2.0.3.min.js') }}"></script>
    <script src="{{asset ('public/theme_admin/js/raphael-min.js') }}"></script>
    <script src="{{asset ('public/theme_admin/js/morris.js') }}"></script>
...
<script src="{{asset ('public/theme_admin/js/jquery.nicescroll.j') }}s"></script>
...
<!-- calendar -->
<script type="text/javascript" src="{{asset ('public/theme_admin/js/monthly.js') }}"></script>
...
<script src="{{asset ('public/theme_admin/ckfinder/ckfinder.js')}}"></script>
<script>
