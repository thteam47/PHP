...
<link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('public/frontend/images/ico/apple-touch-icon-144-precomposed.pn')}}g">
...
<script src="{{('pubic/frontend/js/jquery.js')}}"></script>
<script src="{{('pubic/frontend/js/bootstrap.min.js')}}"></script>
<script src="{{('pubic/frontend/js/jquery.scrollUp.min.js')}}"></script>
<script src="{{('pubic/frontend/js/price-range.js')}}"></script>
<script src="{{('pubic/frontend/js/jquery.prettyPhoto.js')}}"></script>
<script src="{{('pubic/frontend/js/main.js')}}"></script>
</body>
</html>